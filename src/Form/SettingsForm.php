...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['selection_rules_settings'] = [
      ...
      '#description' => $this->t('Define rules for selecting an image based on the total number of canvases in a manifest. The first matching rule from the top will be used. If no rules match, a random image from all canvases will be selected.'),
    ];
    $form['selection_rules_settings']['selection_rules'] = [
      ...
      '#description' => $this->t('
            ...
            <ul>
                ...
                <li><code>random(1-5)</code>: Select a random canvas from the 1st to the 5th.</li>
            </ul>
        '),
    ];
